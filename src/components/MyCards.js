                ...
                <View style={[styles.bgFullWidth,styles.bg_White,styles.paddingHorizontal_20,
                    ...
                    <View style={[styles.directionRow,styles.marginBottom_35]}>
                        ...
                        <View style={{marginLeft:15}}>
                            <Text style={[styles.textBold , styles.text_black , styles.textSize_14]}>{ i18n.t('myCards') }</Text>
                            <Text style={[styles.textRegular , styles.text_gray , styles.textSize_13]}>{ i18n.t('registeredCards') }</Text>
                        </View>
                    </View>
