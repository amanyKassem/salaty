                ...
                <View style={[styles.bgFullWidth,styles.paddingHorizontal_20 ,styles.bg_White,
                    ...
                    <View style={[styles.directionRow,styles.marginBottom_35]}>
                        ...
                        <View style={{marginLeft:15}}>
                            <Text style={[styles.textBold , styles.text_black , styles.textSize_14]}>{ i18n.t('bankAccounts') }</Text>
                            <Text style={[styles.textRegular , styles.text_gray , styles.textSize_13]}>{ i18n.t('registeredBank') }</Text>
                        </View>
                    </View>
